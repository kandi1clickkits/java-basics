...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/java-basics/releases/download/v1.0.0/java-basics-main.zip
SET REPO_NAME=java-basics-main.zip
SET EXTRACTED_REPO_DIR=java-basics-main
SET FILE_NAME=DateTime.java
where /q javac
IF ERRORLEVEL 1 (
	ECHO==========================================================================
